  ...
  return (
    <div className="tool-page container">
      <Seo
        ...
        description="Pick a color and find matching Chessex, Gamegenic, and spindown Magic dice on Amazon."
        path="/dice"
      />
      ...
      <div className="split">
        <div className="panel">
          <div className="field">
            <label htmlFor="dice-color">Color</label>
            <input
              id="dice-color"
              type="color"
              value={color}
          ...
          <div className="field" style={{ marginTop: "1rem" }}>
            <label htmlFor="dice-kind">Dice type</label>
            <select
              id="dice-kind"
              value={kind}
              onChange={(e) => setKind(e.target.value as DiceKind)}
            >
          ...
          <label className="check" style={{ marginTop: "1rem" }}>
            ...
            Prefer premium brands (Chessex / Gamegenic; soft preference)
          </label>
          <div className="actions">
            <button
              type="button"
              className="btn btn-primary"
              onClick={() => void onFindDice()}
              disabled={loading}
            >
              {loading ? "Matching…" : "Find dice"}
            </button>
          </div>
        </div>
        ...
        <div className="panel panel-strong">
          {loading && (
            <div
              ...
              aria-label="Dice matching progress"
              style={{ marginTop: 0 }}
            >
          ...
          {result ? (
            <>
              ...
              <a
                ...
                href={
                  isSafeExternalHref(result.url)
                    ? result.url
                    : "https://www.amazon.com/s?k=Chessex+opaque+dice"
                }
                target="_blank"
          ...
          {!loading && !result ? (
            <p className="muted">Adjust your color and options, then click Find dice.</p>
          ) : null}
        </div>
      </div>
    </div>
